...
1. When I run the coref.py, I have a error is  "list index out of range in utils.py line73, in pack" .
   ...
   <center class="half">
       <img src="https://lizhuoranget.github.io/images/20200928coref/error_outoflist.png" width="30%" >
       <p>图 错误</p>
        <img src="https://lizhuoranget.github.io/images/20200928coref/debug_outoflist.png" width="30%" >
       <p>图 代码修改</p>
   </center>
